...
The programm implements a lexical analyzer, recognizing the tokens from the input with regular expression using flex and putting them in a single linked list of tokens.
